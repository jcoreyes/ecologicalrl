...
if __name__ == "__main__":
    ...
    3. use_gpu 
    """
    exp_prefix = 'tool-dqn-dynamic-static'
    n_seeds = 10
    mode = 'ec2'
    use_gpu = False
    ...
    algo_variant = dict(
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=64,
            validation_envs_pkl=join(get_repo_dir(), 'experiments/continual/dynamic_static/axe/validation_envs/dynamic_static_validation_envs_2020_05_30_15_35_03.pkl'),
            # TODO originally 200
