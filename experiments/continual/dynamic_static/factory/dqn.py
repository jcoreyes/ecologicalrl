...
if __name__ == "__main__":
    ...
    3. use_gpu 
    """
    exp_prefix = 'factory-axe-dynstat'
    n_seeds = 1
    mode = 'ec2'
    use_gpu = False
    ...
    algo_variant = dict(
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=64,
            validation_envs_pkl=join(get_repo_dir(), 'experiments/continual/dynamic_static/factory/validation_envs/dynamic_static_validation_envs_2020_02_05_08_01_55.pkl'),
