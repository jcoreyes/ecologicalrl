...
if __name__ == "__main__":
    ...
    algo_variant = dict(
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=64,
            validation_envs_pkl=join(get_repo_dir(), 'experiments/continual/env_shaping/distance_increasing/axe/validation_envs/dynamic_static_validation_envs_2019_09_20_00_23_56.pkl'),
