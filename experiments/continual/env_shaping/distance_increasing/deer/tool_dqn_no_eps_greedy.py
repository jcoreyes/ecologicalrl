...
if __name__ == "__main__":
    ...
    algo_variant = dict(
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=64,
            validation_envs_pkl=join(get_repo_dir(), 'experiments/continual/env_shaping/distance_increasing/deer/validation_envs/dynamic_static_validation_envs_2020_05_30_15_32_42.pkl'),
