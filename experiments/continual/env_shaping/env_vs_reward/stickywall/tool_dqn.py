...
if __name__ == "__main__":
    ...
    3. use_gpu 
    """
    exp_prefix = 'tool-dqn-env-shaping-stickywall'
    n_seeds = 1
    mode = 'ec2'
    use_gpu = False
    ...
    algo_variant = dict(
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=64,
            validation_envs_pkl=join(get_repo_dir(), 'examples/continual/env_shaping/env_vs_reward/stickywall/validation_envs/dynamic_static_validation_envs_2019_11_06_05_46_47.pkl'),
