...
if __name__ == "__main__":
    ...
    3. use_gpu 
    """
    exp_prefix = 'tool-dqn-env-shaping-intermediate-12x12-gen'
    n_seeds = 1
    mode = 'ec2'
    use_gpu = False
    ...
    algo_variant = dict(
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=256,
            validation_envs_pkl=join(get_repo_dir(), 'examples/continual/env_shaping/intermediate_resources/berry/validation_envs/dynamic_static_validation_envs_12x12_2019_09_18_04_42_30.pkl'),
