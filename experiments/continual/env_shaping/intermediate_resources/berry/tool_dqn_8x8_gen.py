...
if __name__ == "__main__":
    ...
    3. use_gpu 
    """
    exp_prefix = 'tool-dqn-env-shaping-intermediate-8x8-berry-gen'
    n_seeds = 1
    mode = 'ec2'
    use_gpu = False
    ...
    env_variant = dict(
        ...
        replenish_empty_resources=['metal', 'wood', 'tree'],
    ...
    env_search_space.update(
        resource_prob=[
            {'metal': 0.01, 'wood': 0.01, 'tree': 0.005, 'axe': 0.005, 'berry': 0.005},
            {'metal': 0.02, 'wood': 0.02, 'tree': 0.01, 'axe': 0.01, 'berry': 0.01},
            {'metal': 0.05, 'wood': 0.05, 'tree': 0.025, 'axe': 0.025, 'berry': 0.025}
        ],
        resource_prob_decay=[
            {'axe': 1e-6, 'berry': 1e-6},
            {'axe': 2e-7, 'berry': 2e-7},
    ...
    algo_variant = dict(
        ...
        version="intermediate resources - berry",
        lifetime=True,
        layer_size=16,
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=256,
            validation_envs_pkl=join(get_repo_dir(), 'examples/continual/env_shaping/intermediate_resources/berry/validation_envs/dynamic_static_validation_envs_8x8_2019_09_18_04_41_47.pkl'),
