...
if __name__ == "__main__":
    ...
    algo_variant = dict(
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=64,
            validation_envs_pkl=join(get_repo_dir(), 'examples/continual/env_shaping/lava/axe/validation_envs/env_shaping_validation_envs_2020_01_23_03_09_04.pkl'),
