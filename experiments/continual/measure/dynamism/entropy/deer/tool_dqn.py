...
if __name__ == "__main__":
    ...
    3. use_gpu 
    """
    exp_prefix = 'tool-dqn-dynamism-deer-entropy'
    n_seeds = 5
    mode = 'local'
    use_gpu = False
    ...
    algo_variant = dict(
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=64,
            validation_envs_pkl=join(get_repo_dir(), 'experiments/continual/measure/dynamism/entropy/deer/validation_envs/dynamic_static_validation_envs_2020_05_21_18_38_01.pkl'),
