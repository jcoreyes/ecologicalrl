...
if __name__ == "__main__":
    ...
    3. use_gpu 
    """
    exp_prefix = 'tool-dqn-dynamism-axe-hitting'
    n_seeds = 25
    mode = 'local'
    use_gpu = False
    ...
    algo_variant = dict(
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=64,
            validation_envs_pkl=join(get_repo_dir(), 'experiments/continual/measure/dynamism/hitting/axe/validation_envs/dynamic_static_validation_envs_2020_06_01_03_22_29.pkl'),
