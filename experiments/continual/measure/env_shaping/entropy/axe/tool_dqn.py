...
if __name__ == "__main__":
    ...
    algo_variant = dict(
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=64,
            validation_envs_pkl=join(get_repo_dir(), 'experiments/continual/measure/env_shaping/entropy/axe/validation_envs/dynamic_static_validation_envs_2020_05_27_00_42_26.pkl'),
