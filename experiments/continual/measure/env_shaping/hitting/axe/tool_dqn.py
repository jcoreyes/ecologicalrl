...
if __name__ == "__main__":
    ...
    algo_variant = dict(
        algorithm="DQN",
        version="distance increase - axe - hitting",
        layer_size=16,
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=64,
            validation_envs_pkl=join(get_repo_dir(), 'experiments/continual/measure/env_shaping/hitting/axe/validation_envs/dynamic_static_validation_envs_2020_05_21_17_29_06.pkl'),
